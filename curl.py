...
for data in datas:
	...
	sbd_str = '0' + str(sbd)
	data = data.split("\\n")
	# file = open('test_data.txt',encoding='utf8', mode='w')
	# file.write(data)
	...
	# choose relavent(liên quan) infomation
	name = data[7]
	dob = data[8]
	scores = data[9]
	...
	# file = open('test_data.txt',encoding='utf8', mode='a')
	# for i in range(len(data)):
	# 	file.write(data[i]+',')
